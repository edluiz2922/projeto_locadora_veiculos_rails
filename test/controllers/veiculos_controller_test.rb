...
class VeiculosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create veiculo" do
    assert_difference('Veiculo.count') do
      post veiculos_url, params: { veiculo: { cor: @veiculo.cor, marca_id: @veiculo.marca_id, nome: @veiculo.nome, placa: @veiculo.placa, qtde_passageiro: @veiculo.qtde_passageiro, valor: @veiculo.valor } }
    end
  ...
  test "should update veiculo" do
    patch veiculo_url(@veiculo), params: { veiculo: { cor: @veiculo.cor, marca_id: @veiculo.marca_id, nome: @veiculo.nome, placa: @veiculo.placa, qtde_passageiro: @veiculo.qtde_passageiro, valor: @veiculo.valor } }
